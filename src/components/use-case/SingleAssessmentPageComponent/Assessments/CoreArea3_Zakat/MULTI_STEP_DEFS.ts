...
export const MULTI_STEP_DEFS: SingleStep = {
    ...
    1: [
        ...
        {
            label: 'Shariah Advisory board established to advise, set policies, review and assessment',
            ...
            options: [
                ...
                { value: 'sab-assessment', label: 'SAB: assessment' },
    ...
    2: [
        ...
        {
            label: 'Assessment procedures (internal/external)',
            id: 'assessment-procedures',
            options: [
                { value: 'assessment-available', label: 'Assessment available' },
                { value: 'assessor-names-data', label: 'Assessors names/data available' },
            ]
        },
    ],
    3: [
