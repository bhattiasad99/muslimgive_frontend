...
export type AssessmentSlug = keyof typeof AUDIT_DEFINITIONS;

export const isAssessmentSlug = (value: string): value is AssessmentSlug => {
    return Boolean(AUDIT_DEFINITIONS[value as AssessmentSlug]);
};
