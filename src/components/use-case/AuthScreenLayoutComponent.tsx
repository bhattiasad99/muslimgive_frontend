...
const AuthScreenLayoutComponent: FC<IProps> = ({ heading, subHeading, children, action }) => {
    return (
        <>
            <form action={action} className="bg-white p-4 md:p-8 rounded-lg border-[rgba(148,148,148, 0.1)] flex flex-col items-center gap-6 max-w-[528px] min-w-[300px] w-[40vw]">
